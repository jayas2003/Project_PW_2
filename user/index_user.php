...
<style>
        /* CSS untuk membuat tautan terlihat seperti tombol */
        .button_login {
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    ...
                    <div id="menu" class="col-lg- col-md-9 d-none d-md-block nav-item">
                        <ul>
                            <li><a href="#">Home</a></li>
                            <li><a href="#about_us">About Us</a></li>
                            <li><a href="#gallery">Gallery</a></li>
                            <li><a href="#contact_us">Contact Us</a></li>
                            <li><a href="login_form_user.php" class="button_login">Login</a></li>
                            <li><a href="login_form_admin.php" class="button_admin">Admin</a></li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Best Free Clinic </h5>
                        <p class="animated bounceInLeft">"Kesehatan bukanlah tujuan hidup. Tetapi kesehatan adalah dasar untuk mencapai semua tujuan dalam hidup." - Hugh Simon</p>
